...
photoArray = ["fotoOcho.jpg","fotoTres.JPG","fotoSiete.jpg"];

var calcRandom;
calcRandom = 0;
document.getElementById("galleryJS").src = photoArray[calcRandom];


document.getElementById("btn-container").addEventListener("click", function () {
    calcRandom === 2 ? calcRandom = 0 : calcRandom++;
    document.getElementById("galleryJS").src = photoArray[calcRandom];

    document.getElementById("interactiveBlock").classList.toggle("black-bg");
});
